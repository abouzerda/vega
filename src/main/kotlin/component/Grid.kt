...
object Grid : Component() {
    ...
    override fun update(dt: Float) {
        val cameraPos: Vector2f = GLFWWindow.currentScene.camera.position
        val projectionSize: Vector2f = GLFWWindow.currentScene.camera.projectionSize
        ...
        val width: Int = projectionSize.x.toInt() + Settings.GRID_WIDTH * 2
        val height: Int = projectionSize.y.toInt() + Settings.GRID_HEIGHT * 2
